...
/**
 *	\file       edisuivi/edisuiviindex.php
 *	\ingroup    edisuivi
 *	\brief      Home page of edisuivi top menu
 */
...
$langs->loadLangs(array("edisuivi@edisuivi"));

$action=GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->edisuivi->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("EDISuiviArea"));

print load_fiche_titre($langs->trans("EDISuiviArea"), '', 'edisuivi.png@edisuivi');
...
// Draft MyObject
if (! empty($conf->edisuivi->enabled) && $user->rights->edisuivi->read)
{
	$langs->load("orders");
