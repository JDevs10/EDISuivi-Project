...
/**
 * \file    edisuivi/core/boxes/edisuiviwidget1.php
 * \ingroup edisuivi
 * \brief   Widget provided by EDISuivi
 *
 ...
 */
class edisuiviwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "edisuivibox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "edisuivi@edisuivi";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->edisuivi->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/edisuivi/class/edisuivi.class.php");

		// Populate the head at runtime
		$text = $langs->trans("EDISuiviBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_edisuivi@edisuivi',
		...
		$this->info_box_contents = array(
			0 => array( // First line
				0 => array( // First Column
					...
					'textnoformat' => '<div><h1>Hello JL</h1></div>',
