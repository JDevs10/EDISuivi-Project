...
//$help_url="EN:Module_Commentaire|FR:Module_Commentaire_FR|ES:Módulo_Commentaire";
$help_url = '';
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/edisuivi/commentaire_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'title_companies', 0, $newcardbutton, '', $limit);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendCommentaireRef";
$modelmail = "commentaire";
$objecttmp = new Commentaire($db);
