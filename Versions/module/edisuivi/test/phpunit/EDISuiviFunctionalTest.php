...
/**
 * \file    test/functional/EDISuiviFunctionalTest.php
 * \ingroup edisuivi
 ...
 *
 * @package Testedisuivi
 */
class EDISuiviFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/edisuivi/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('edisuivi/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/edisuivi/admin/about.php');
		$this->authenticate();
		return $this->assertContains('edisuivi/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('edisuiviwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modEDISuivi_EDISuiviTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEDISuivi_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
